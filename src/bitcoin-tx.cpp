...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bacoin transaction") + "\n" +
              "  bacoin-tx [options] -create [commands]   " + _("Create hex-encoded bacoin transaction") + "\n" +
              "\n";
